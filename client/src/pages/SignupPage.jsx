        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="backdrop-blur-sm bg-white/80 rounded-2xl shadow-xl overflow-hidden border border-blue-100">
            ...
            <div className="px-8 pt-8 pb-6 border-b border-blue-50">
              <h2 className="text-2xl font-bold text-gray-900 text-center">Register Your Own Account</h2>
            ...
            <div className="p-8">
              <form onSubmit={handleSignup} className="space-y-6">
                ...
                {/* Success Message */}
                {success && (
                  <div className="bg-green-50/80 backdrop-blur-sm border-l-4 border-green-500 p-4 rounded-xl">
                    <div className="flex">
                      <div className="flex-shrink-0">
